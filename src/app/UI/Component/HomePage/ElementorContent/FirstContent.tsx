      ...
      <div className="flex xl:flex-row flex-col items-start justify-start xl:items-center xl:justify-center xl:space-y-0 space-y-10">
        <div className="relative overflow-hidden">
          ...
          <button className="absolute xl:bottom-28 bottom-5 left-10" >
            <p className="text-4xl font-medium" onMouseEnter={handleMouseEnterFirstImage} onMouseLeave={handleMouseLeaveFirstImage}>Dress</p>
            <span
          style={{
        ...
        />
         ...
         <div className="relative overflow-hidden xl:ml-64 rounded-border-tl-5xl">
          <img src={shirt.src} alt="shirt" className="object-cover transform transition-transform duration-300 hover:scale-105"/>
          <Link href='/'>
