      ...
      <div className="flex flex-col items-center justify-center 2xl:mx-0 xl:mx-60 lg:mx-10 md:mx-7 mx-0">
        <div className="flex flex-col items-start justify-start 2xl:items-center 2xl:justify-center xl:items-center xl:justify-center lg:items-center lg:justify-center space-y-4">
          {orders.length > 0 ? (
                ...
                <AccordionDetails>
                  <div className="flex flex-col items-start justify-start space-y-6">
                    ...
                    <div className="flex flex-col items-start justify-start space-y-4">
                      <h1>Total Amount: <span className="text-lg font-medium text-red-500">${order.totalAmount.toFixed(2)}</span></h1>
                      <h1>Payment Method: <span className="text-lg font-medium text-red-500">{order.paymentMethod}</span></h1>
                    </div>
                  </div>
                </AccordionDetails>
              </Accordion>
            ...
            <p className="flex items-center justify-center text-5xl font-medium text-red-500">No orders found.</p>
          )}
        </div>
